                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Harga WeekDay</th>
                                                                <th>Harga WeekEnd</th>
                                                                <th>Sub Kategori</th> <!-- Kolom Sub Kategori -->
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                while ($row = $result->fetch_assoc()) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?= htmlspecialchars($row['sub_kategori_product']); ?></td> <!-- Sub Kategori -->
                                                                        <td>
                                                                            <div class="d-flex gap-2">
                                                                                <a href="#" class="btn btn-warning text-light" data-bs-toggle="modal" data-bs-target="#editProductModal" 
                                                                                    ...
                                                                                    data-subcategory="<?= htmlspecialchars($row['sub_kategori_product']); ?>" 
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="addProductForm" action="save_product.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="kategori_product" value="Penginapan">
                                    ...
                                    <div class="mb-3">
                                        <label for="sub_kategori_product" class="form-label">Kategori Produk</label>
                                        <select class="form-control" name="sub_kategori_product" id="sub_kategori_product" required>
                                            <option value="" disabled selected>Pilih Kategori Penginapan</option>
                                            <option value="Penginapan Bungalow">Penginapan Bungalow</option>
                                            <option value="Penginapan Kerucut">Penginapan Kerucut</option>
                                            <option value="Penginapan Lumbung">Penginapan Lumbung</option>
                                            <option value="Penginapan Panggung">Penginapan Panggung</option>
                                        </select>
                                    </div>
