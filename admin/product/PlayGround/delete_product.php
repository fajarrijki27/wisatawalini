...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Produk berhasil dihapus!'); window.location.href='playground.php';</script>";
    } else {
        echo "<script>alert('Gagal menghapus produk.'); window.location.href='playground.php';</script>";
    }
