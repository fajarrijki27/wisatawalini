                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> 
                            ...
                            <ul class="nav nav-treeview" role="group">
                                ...
                                <!-- Rekap Bulanan -->
                                <li class="nav-item"> 
                                    <a href="perbulan.php" class="nav-link" role="menuitem"> 
                                        <i class="nav-icon bi bi-circle"></i>
        ...
        <main class="app-main">
            <div class="app-content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Rekap Data Per-bulan</h3>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h3 class="card-title">Rekap Data Per-bulan</h3>
                                    <form id="filterForm" class="mt-3">
                                        <input type="month" id="bulanTahunInput" class="form-control" required />
                                ...
                                <div class="card-footer clearfix">
                                    ...
                                    <button id="printBtn" class="btn btn-secondary mt-3" onclick="printTable()">Print</button>
                                    <button id="excelBtn" class="btn btn-success mt-3" onclick="exportToExcel()">Export to Excel</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    document.getElementById('filterForm').addEventListener('submit', function (e) {
        e.preventDefault();
        const bulanTahun = document.getElementById('bulanTahunInput').value; // Ambil nilai bulanTahun
        loadPage(bulanTahun, 1); // Muat halaman pertama
    });

    function loadPage(bulanTahun, page) {
        fetch(`backend.php?bulanTahun=${bulanTahun}&page=${page}`)
                ...
                for (let i = 1; i <= totalPages; i++) {
                    paginationHtml += `
                        <li class="page-item ${i === current_page ? 'active' : ''}">
                            <a class="page-link" href="javascript:void(0)" onclick="loadPage('${bulanTahun}', ${i})">${i}</a>
                        </li>
                    `;
                }
    ...
    function printTable() {
        const content = document.getElementById('dataContainer').innerHTML;
